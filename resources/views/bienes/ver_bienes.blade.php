...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light p-4">
        <div class="container-fluid justify-content-end">
            <button style="margin-right: 10px" class="btn btn-success" onclick="window.location.href='{{ route('export_bienes') }}';">
                Exportar
            </button>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('agregar_bienes') }}" method="POST">
                        <div class="modal-body">
                            ...
                            {{-- <div class="mb-3">
                                <label for="estado" class="form-label">Ingrese para estado prueba: </label>
                            ...
                            <div class="mb-3">
                                <label for="descripcion_bien_id" class="form-label">Ingrese Descripción de bien: </label>
                                <select id="descripcion_bien_id" name="descripcion_bien_id" class="form-select"
                                    aria-label="Default select example">
                                    <option value="">Seleccione una opción..</option>
                                    @foreach ($descripcion_biens as $descripcion_bien)
                                        <option value="{{ $descripcion_bien->id }}">{{ $descripcion_bien->descripcion }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
        ...
        <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('eliminar_bienes') }}" method="POST">
                        <div class="modal-body">
                            @csrf
                            <div class="mb-3">
